...
func (w *webhookCustomer) MarshalJSON() ([]byte, error) { return json.Marshal(w.customer) }
...
func (w *webhookProduct) MarshalJSON() ([]byte, error) { return json.Marshal(w.product) }
...
func (w *webhookPrice) MarshalJSON() ([]byte, error) { return json.Marshal(w.price) }
...
func (w *webhookCheckoutSession) MarshalJSON() ([]byte, error) { return json.Marshal(w.session) }
...
func (w *webhookSubscription) MarshalJSON() ([]byte, error) { return json.Marshal(w.subscription) }
...
func (w *webhookInvoice) MarshalJSON() ([]byte, error) { return json.Marshal(w.invoice) }
...
func (w *webhookCharge) MarshalJSON() ([]byte, error) { return json.Marshal(w.charge) }
